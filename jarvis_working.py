...
- No emojis/unicode that break Windows console
...
print("\n" + "="*60)
print("  JARVIS SUPER AGENT - WORKING VERSION")
print("="*60)
...
def main():
    ...
    print("="*60)
    print("\n  NEW: Scheduled Tasks, Reminders, Recurring Commands")
    print("="*60 + "\n")
    
    speak("JARVIS Super Agent online. Scheduler active, Sir.")
